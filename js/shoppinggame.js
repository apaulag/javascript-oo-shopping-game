...
Object.defineProperty(Product.prototype, "getDetails", {
    value() { return `Product Name: ${this.name} , Product Price: ${this.price}` }
});
...
function init(data) {
    if (Object.is(data, undefined) == false && gameComplete == true) {
        ...
        rl.question("What's your name? ", function (name) {
            // Assign the player object's name property to the user entered name
            player.name = name;
    ...
    // Complete this function
    const rateAndExit = () => {
        // Create a new instance of Rating and assign it to a variable named playerRating
